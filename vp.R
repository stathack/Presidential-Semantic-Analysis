negative.words <- scan("~/Dropbox/Shared/opinion-lexicon-English/negative-words.txt",           what='character',comment.char=';')
positive.words <- scan("~/Dropbox/Shared/opinion-lexicon-English/positive-words.txt",           what='character',comment.char=';')
vp<-function(x){
